...
def build_agent_card(
    *,
    ...
    data_source_dependencies: dict[str, list[str]] = {}
    ...
    for capability_name, registered in registered_capabilities.items():
        ...
        if registered.data_sources:
            data_source_dependencies[skill_id] = list(registered.data_sources)
    ...
    if data_source_dependencies:
        conducto_params["dataSourceDependencies"] = data_source_dependencies
